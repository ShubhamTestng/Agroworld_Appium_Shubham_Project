...
public class Utility {
	...
	public void currentTime() throws InterruptedException {
	    ...
	    int hourIn12HourFormat = currentHour % 12;
	    if (hourIn12HourFormat == 0) { // Handle midnight and noon correctly
		...
		Thread.sleep(1000);
		hourInputField.sendKeys(String.valueOf(hourIn12HourFormat));
	    minuteInputField.sendKeys(String.valueOf(currentMinutes));
	    
//		appiumdriver.findElement(By.xpath("//android.widget.Spinner[@resource-id=\"android:id/am_pm_spinner\"]")).click();
//	    
//	    if (currentHour >= 0 && currentHour < 12) {
//            // Select AM if the current hour is between 0 (inclusive) and 12 (exclusive)
//            WebElement AM = appiumdriver.findElement(By.xpath("//android.widget.CheckedTextView[@resource-id=\"android:id/text1\" and @text=\"AM\"]"));
//            AM.click();
//        } else {
//            // Select PM if the current hour is between 12 (inclusive) and 24 (exclusive)
//            WebElement PM = appiumdriver.findElement(By.xpath("//android.widget.CheckedTextView[@resource-id=\"android:id/text1\" and @text=\"PM\"]"));
//            PM.click();
//        }
	}
